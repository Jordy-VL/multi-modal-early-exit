...
python3 IC_only.py with layoutlmv3 model=EElayoutlmv3 dataset=jordyvl/rvl_cdip_easyocr epochs=60 batch_size=2 gradient_accumulation_steps=24 gamma=0.7 encoder_layer_strategy=ramp training_strategy=one_stage_subgraphs_weighted exits="text_avg,1,4,8,10" -n Independent_Quarter_Ramp_Full